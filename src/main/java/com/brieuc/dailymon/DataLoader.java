...
public class DataLoader implements ApplicationRunner {
    ...
    @Autowired
    public DataLoader(ModelRepository modelRepository, UserRepository userRepository,
